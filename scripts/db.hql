...
CREATE EXTERNAL TABLE IF NOT EXISTS chess_moves_partitioned (
    id INT,
    game_uuid STRING,
    game_url STRING,
    game_year INT,
...
INSERT OVERWRITE TABLE chess_moves_partitioned PARTITION(archive_month)
SELECT 
    ...
    white_won_flag, black_won_flag, draw_flag, created_at, updated_at,
    archive_month
